        ...
        <?php else: ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                <?php foreach ($packages as $pkg):
                    ...
                    $wa_msg = "Halo Lombok Travel! Saya tertarik dengan paket *{$pkg['name']}*. Mohon informasi lebih lanjut.";
...
<section class="bg-gradient-to-r from-brand-700 to-brand-900 py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        <a href="<?= generateWaLink($wa_number, 'Halo Lombok Travel! Saya ingin membuat paket wisata custom Lombok.') ?>" target="_blank"
