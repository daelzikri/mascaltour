...
$route_images = [
    'https://images.unsplash.com/photo-1596422846543-75c6fc197f0c?auto=format&fit=crop&w=800&q=80',  // airport
    'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=800&q=80',  // road trip
    'https://images.unsplash.com/photo-1598077886271-5d2a77e61ee2?auto=format&fit=crop&w=800&q=80',  // gili boat dock
    'https://images.unsplash.com/photo-1551963831-b3b1ca40c98e?auto=format&fit=crop&w=800&q=80',  // lombok scenic
    'https://images.unsplash.com/photo-1617981893810-c8afe1e71b27?auto=format&fit=crop&w=800&q=80',  // harbour
    'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=800&q=80',  // mountain
];
?>
        ...
        <?php else: ?>
            <div class="space-y-6">
                <?php foreach ($routes as $idx => $route):
                    $img_src = $route_images[$idx % count($route_images)];
                ...
                ?>
                    <div class="bg-white rounded-3xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 hover:-translate-y-0.5">
                        <div class="flex flex-col md:flex-row">
                            <!-- Route Image -->
                            <div class="md:w-64 h-44 md:h-auto shrink-0 overflow-hidden">
                                <img src="<?= e($img_src) ?>" alt="<?= e($route['name']) ?>"
                            ...
                            <div class="flex-1 p-6 flex flex-col md:flex-row gap-6">
                                ...
                                <!-- CTA Side -->
                                <div class="md:w-40 flex flex-col justify-center items-center gap-3 text-center shrink-0">
